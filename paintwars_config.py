...
arenaIndexSelector = 3# numéro de l'arène, entre 0 et 4

# Starting position
invertStartingPosition = False # True: red commence à gauche. Sinon, commence à droite.

# Red team
import paintwars_team_koceila_nabil # importer votre code
get_name_red_team = paintwars_team_koceila_nabil.get_team_name # mettre ici votre fonction get_team_name
step_red_team = paintwars_team_koceila_nabil.step # mettre ici votre fonction step
